	...
	<body>
		...
		<section class="border mb-2 p-section">
			...
			<p>
				...
				change a personal situation, a mental setting, or a physical environment. The campaign starts in cities,
				then moves to states, and will be available as an online platform to make a global impact. If you see
				the
				<em>Pray Up logo</em>, take it as a reminder; more than ever, we live in a time that prayer is needed.
				Local churches in Marion, Indiana, are coming together in <em>“Pray Up Teams”</em> because they see the
				effects of Pray Up’s vision and still believe in the power of prayer. Pray Up is currently enrolled in
				Elevate Ventures to raise capital for the development of the fully functional app.
			</p>
		</section>
